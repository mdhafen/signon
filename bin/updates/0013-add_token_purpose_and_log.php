...
if ( $row['count'] == 0 ) {
  ...
  $query = "CREATE TABLE token_log ( uid VARCHAR(40) NOT NULL, user MEDIUMTEXT, ip VARCHAR(40) NOT NULL DEFAULT '0.0.0.0', purpose ENUM('pass_reset','authen') NOT NULL, timestamp datetime DEFAULT CURRENT_TIMESTAMP, PRIMARY KEY (uid) ) ENGINE=InnoDB DEFAULT CHARSET=utf8";
  $dbh->exec( $query );
