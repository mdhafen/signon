...
INSERT INTO `message_templates` (`code`,`transport`,`lang`,`subject`,`body`) VALUES
  ('PASSWD_RESET','EMail','en-us','WCSD SignOn / Google password reset','Click this link to reset your WCSD SignOn / Google password : [[_BASE_URL]]/change_password.php?op=Reset&uid=[[UID]]&token=[[TOKEN]].  This link will expire after [[TOKEN_INTERVAL]].');
